                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <div class="button-items">
                                            ...
                                            data-bs-target="#bs-example-modal-xl" data-remote="reg-locales.php" data-sb-backdrop="static" data-sb-keyboard="false">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                while($floc = mysqli_fetch_array($sqlLocales)){
                                                    ...
                                                    $nombre_sucursal = $floc['nombre_sucursal'];
                                                    $alias = $floc['alias'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        data-remote="mod-locales.php?cod_puntoventa=<?=$cod_puntoventa?>" data-sb-backdrop="static" 
