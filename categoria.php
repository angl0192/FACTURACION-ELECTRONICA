                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">ADMINISTRAR CATEGORÍAS</h4>

                                    <div class="page-title-right">
                                        <div class="button-items">
                                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" 
                                            data-bs-target="#bs-example-modal-xl" data-remote="reg-categoria.php" data-sb-backdrop="static" data-sb-keyboard="false">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        data-remote="mod-categoria.php?cod_categoria=<?=$cod_categoria?>" data-sb-backdrop="static" 
